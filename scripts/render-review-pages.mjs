...
function page(article,stats){
  const sections=article.sections||[];
  const scoreMeta=Number.isFinite(Number(article.score))?`<strong class="article-score">${esc(article.score)} / 10</strong>`:'';
