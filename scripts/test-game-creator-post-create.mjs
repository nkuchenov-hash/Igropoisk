...
const bootstrapAt=enrichmentWorkflow.indexOf('POST_CREATE_PHASE: bootstrap'),bootstrapPublishAt=enrichmentWorkflow.indexOf('POST_CREATE_PUBLISH_PHASE: bootstrap'),modelAt=enrichmentWorkflow.indexOf('Restore local editorial model cache'),quickAt=enrichmentWorkflow.indexOf('build-review-bootstrap-commercial.mjs'),quickPublishAt=enrichmentWorkflow.indexOf('POST_CREATE_PUBLISH_PHASE: quick-review'),visionAt=enrichmentWorkflow.indexOf('Ensure optional local vision model for full upgrades'),fullAt=enrichmentWorkflow.indexOf('POST_CREATE_PHASE: full-review'),fullPublishAt=enrichmentWorkflow.indexOf('POST_CREATE_PUBLISH_PHASE: full-review');
