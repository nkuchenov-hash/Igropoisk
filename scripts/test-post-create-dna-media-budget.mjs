...
for(const marker of ['scripts/build-game-dna.mjs','scripts/validate-game-dna.mjs','scripts/build-similarity-index.mjs','data/parser-runs/game-post-create-dna.json','missingDnaSlugs','game/${slug}/index.html',"game_dna:'ready'","dna:'ready'",'validation_scope:\'targeted_created_games_only\'',"run('scripts/validate-game-dna.mjs',builtSlugs)"])if(!dna.includes(marker))fail(`Post-create DNA materializer missing: ${marker}`);
...
console.log('Post-create targeted DNA and bounded media contract passed.');
