...
for(const marker of ['data/reviews/${slug}.json','acceptedProfessionalReview','professional_review_evidence','turn-based combat','create your character','side quest','story-rich','strongFastPacingEvidence'])if(!builder.includes(marker))fail(`Game DNA builder is not using bounded professional review evidence correctly: ${marker}`);
