...
assert(homepage.includes('assets/reviews-of-day/index.css?v=20260804-1'), 'Reviews-of-day stylesheet is missing.');
assert(homepage.includes('assets/home-releases/index.css?v=20260804-1'), 'Home releases stylesheet is missing.');
assert(homepage.includes('assets/reviews-of-day/index.js?v=20260804-1'), 'Reviews-of-day script is missing.');
