...
try{
  ...
  await page.waitForFunction(()=>document.querySelector('#gameTitle')?.textContent?.trim()==='Baldur’s Gate 3',{timeout:15000});await new Promise(resolve=>setTimeout(resolve,2200));
