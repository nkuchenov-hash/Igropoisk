...
const evidence=JSON.stringify({
  draft:{identity:draft.identity,release:draft.release,companies:draft.companies,classification:draft.classification,requirements:draft.requirements,links:draft.links},
  sources,
...
console.log(JSON.stringify({slug,status:'completed_pending_qc',provider,model,paid_api:false,sources:sources.length,repair_attempts:attempts.length,public_ready:false},null,2));
