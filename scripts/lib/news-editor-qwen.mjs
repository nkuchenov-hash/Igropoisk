...
async function generate(generator, prompt, maxNewTokens) {
  return generator(prompt, { max_new_tokens: maxNewTokens, do_sample: false, repetition_penalty: 1.02 });
}
