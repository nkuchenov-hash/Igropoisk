...
const identityBlockedByContentPolicy=item=>newsContentRejectionReasons({
  title:text(item,['titleRu','titleEn','title']),
  summary:text(item,['summaryRu','summaryEn','summary']),
  url:sourceUrl(item)
}).includes('non-gaming technology or entertainment content');
...
for(const item of items){
  ...
  if(!identityBlocked&&!games.length&&!hints.length){
