...
for(const marker of ['data/review-bootstrap/${slug}.json','article/${slug}/index.html','data/reviews/${slug}.json'])if(!renderer.includes(marker))fail(`Bootstrap renderer does not synchronize ${marker}`);
