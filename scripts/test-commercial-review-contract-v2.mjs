...
for(const marker of ['meta_parts','MAX_LEAD_PARTS=3','LEAD_PART_TIMEOUT_MS=150000','LEAD_PART_RETRY_TIMEOUT_MS=90000','LEAD_SENTENCE_PACK_TIMEOUT_MS=90000','LEAD_SENTENCE_PACK_RETRY_TIMEOUT_MS=60000','DEK_TIMEOUT_MS=60000','META_QUALITY_TIMEOUT_MS=120000','SECTION_REUSE_AUDIT_TIMEOUT_MS=120000','MAX_META_QUALITY_PASSES=2','generateLeadPart','generateLeadSentencePack','recoverLeadPart','sentencePackSchema','minItems:4','maxItems:5','leadPartGate','dedupeLeadParts','nearDuplicateText','paragraphDuplicateErrors','auditMeta','auditPersistedSection','quality_reuse_audit','section_quality_rejections','persistent-multi-paragraph-meta-v5-structured-recovery-quality-gated','structured_sentence_pack_recovery:true'])assert.ok(metaPreflight.includes(marker),`persisted editorial quality/recovery safeguard missing: ${marker}`);
