...
assert.ok(synthesis.includes('previousReusable'),'deterministically valid commercial drafts are not reused across retries');
assert.ok(synthesis.includes('persisted article needs editorial revision')||synthesis.includes('persisted-review rewrite failed deterministic gate'),'persisted editorial revision path missing');
...
console.log('Commercial review contract v2 static boundary passed, including provider-independent fallback, bounded research and synthesis latency, persistent deterministic drafts and per-request concurrency.');
